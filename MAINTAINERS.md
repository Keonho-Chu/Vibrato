...
Maintainers own the `vib-rato` repository: they review and merge pull requests,
...
Access is granted at the GitHub repository level. Because `vib-rato` is owned by
