//! Loopback WebSocket server for the Vibrato SDK.
//!
...
fn directed_delivery_receipt_mac(
	...
	mac.update(b"vib-directed-delivery-receipt-v1\0");
...
mod tests {
	...
	fn receipt_digest_matches_only_the_positioned_identity_prerequisite() {
		let raw = r#"{"type":"identity_header","sessionId":"s","repo":"vib-rato","branch":"dev","machine":"test"}"#;
		let positioned = r#"{"type":"event","generation":7,"seq":9,"kind":"identity_header","payload":{"machine":"test","branch":"dev","repo":"vib-rato","sessionId":"s","type":"identity_header"}}"#;
		let stale = r#"{"type":"event","generation":7,"seq":8,"kind":"identity_header","payload":{"type":"identity_header","sessionId":"s","repo":"vib-rato","branch":"stale","machine":"test"}}"#;
		let mislabeled = r#"{"type":"event","generation":7,"seq":9,"kind":"activity","payload":{"type":"identity_header","sessionId":"s","repo":"vib-rato","branch":"dev","machine":"test"}}"#;
	...
	async fn push_frame_broadcasts_threaded_frames_and_preserves_ask() {
		...
		match next_server_msg(&mut ws).await {
			ServerMessage::IdentityHeader(h) => assert_eq!(h.repo, "vib-rato"),
