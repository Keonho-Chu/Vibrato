...
/**
 * Repository-local opt-in: copy this file to .vib/hooks/pre/bash.ts in this checkout.
 * Do not install it under ~/.vib/agent because the enforced PR contract belongs to this repository.
 */
