...
import { authBorrowDisabledForTest } from "@vib-rato/ai/utils/oauth/perplexity";

/**
 * `docs/environment-variables.md` advertises `VIB_AUTH_NO_BORROW` as the switch
...
const KEYS = ["VIB_AUTH_NO_BORROW", "PI_AUTH_NO_BORROW"] as const;
...
describe("Perplexity native-app borrowing opt-out", () => {
	...
	it("honors the documented VIB_AUTH_NO_BORROW", () => {
		setOnly({ VIB_AUTH_NO_BORROW: "1" });
