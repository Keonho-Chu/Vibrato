...
const repoRoot = process.env.VIB_SDK_RENAME_SCAN_ROOT
	? path.resolve(process.env.VIB_SDK_RENAME_SCAN_ROOT)
	: path.resolve(import.meta.dir, "..", "..", "..");
const scannerPath = "packages/coding-agent/scripts/verify-vib-sdk-rename.ts";
...
const forbidden = [
	{ label: "vib-notifications", pattern: /\bvib-notifications\b/i },
	{ label: "vib_notifications", pattern: /\bvib_notifications\b/ },
	{ label: "@vib-rato/notifications", pattern: /@vib-rato[/_-]notifications\b/i },
...
process.stdout.write("Vibrato SDK rename verification passed.\n");
