...
import { VibPluginLoadError, type VibPluginMcpManifestEntry } from "./types";
...
function fail(message: string): never {
	throw new VibPluginLoadError("security_policy", message);
}
...
export function assertStdioAllowed(entry: VibPluginMcpManifestEntry, ctx: StdioPolicyContext): void {
 ...
 */
export function assertMcpInstallPolicy(entry: VibPluginMcpManifestEntry, ctx: StdioPolicyContext): void {
