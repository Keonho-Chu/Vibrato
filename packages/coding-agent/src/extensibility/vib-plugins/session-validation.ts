...
import type { VibBundleIdentity, VibPluginLoadErrorCode, VibPluginRegistryEntry } from "./types";
 ...
 * runtime_mismatch.
 */
export async function verifyEntryHashes(entry: VibPluginRegistryEntry): Promise<SessionQuarantine | null> {
...
function activeSurfaceIds(entry: VibPluginRegistryEntry): {
...
export function validateSessionBundles(
	...
	const active: VibPluginRegistryEntry[] = [];
