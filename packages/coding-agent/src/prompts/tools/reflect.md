Compatibility-only legacy Hindsight helper. This prompt is retained for backend/tool-call compatibility and is not part of the public vib-rato coding harness tool surface.
