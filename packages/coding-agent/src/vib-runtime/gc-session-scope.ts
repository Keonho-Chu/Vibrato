...
/**
 * Managed-scope capacity reporting for `vib gc`.
 *
 ...
 * The scope is filled by Vibrato's own session records, so a heavily used working
 ...
 *
 * `vib gc` already reports on state the operator cannot see, so surfacing scope
