...
export const MANAGED_OWNER_CHILD_TOKEN_ENV = "VIB_MANAGED_OWNER_CHILD_TOKEN";
export const MANAGED_OWNER_COMMAND_ENV = "VIB_MANAGED_OWNER_COMMAND_JSON";
export const MANAGED_OWNER_SESSION_ID_ENV = "VIB_COORDINATOR_SESSION_ID";
export const MANAGED_OWNER_GENERATION_ENV = "VIB_TMUX_OWNER_GENERATION";
export const MANAGED_OWNER_STATE_DIR_ENV = "VIB_TMUX_OWNER_STATE_DIR";
export const MANAGED_OWNER_RUN_ID_ENV = "VIB_MANAGED_OWNER_RUN_ID";
export const MANAGED_OWNER_INCARNATION_ENV = "VIB_MANAGED_OWNER_INCARNATION";
...
export async function runManagedOwnerSupervisor(): Promise<void> {
	...
	if (sigtermRelayed && terminalObservedAt && terminalIntent) {
		await observeOwnerTerminal({
			...
			state_dir: stateDir,
			socket_key: process.env.VIB_TMUX_OWNER_SERVER_KEY ?? "",
