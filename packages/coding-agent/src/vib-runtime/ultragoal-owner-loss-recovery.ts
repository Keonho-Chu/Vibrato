...
let recoveryFsRootLoad: Promise<typeof import("@vib-rato/natives")["openRecoveryFsRoot"]> | undefined;

async function openRecoveryFsRootNative(): Promise<typeof import("@vib-rato/natives")["openRecoveryFsRoot"]> {
...
export async function persistUltragoalRecoveryDecision(input: {
	...
	await writeJsonAtomic(handoffPath, record, {
		cwd: input.cwd,
		audit: { category: "state", verb: "write", owner: "vib-runtime", sessionId: input.sessionId },
	});
