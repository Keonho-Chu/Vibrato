...
import { Agent, AgentBusyError } from "@vib-rato/agent-core";
...
import { FallbackChainController } from "@vib-rato/coding-agent/session/fallback-chain-controller";
import { SessionManager } from "@vib-rato/coding-agent/session/session-manager";
import * as native from "@vib-rato/natives";
import { getProjectAgentDir, logger, TempDir, withTimeout } from "@vib-rato/utils";

const runtimeSignalStoreKey = "__vibAutoContinueSignals";
