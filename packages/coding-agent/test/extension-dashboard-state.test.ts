...
import { applyDisabledExtensionsToState } from "@vib-rato/coding-agent/modes/components/extensions/state-manager";
import type { DashboardState, Extension } from "@vib-rato/coding-agent/modes/components/extensions/types";
