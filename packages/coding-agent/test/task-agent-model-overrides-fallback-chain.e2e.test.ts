...
import { type AssistantMessage, Effort, getBundledModel, type Model } from "@vib-rato/ai";
...
import { resolveAgentModelPatterns } from "@vib-rato/coding-agent/config/model-resolver";
