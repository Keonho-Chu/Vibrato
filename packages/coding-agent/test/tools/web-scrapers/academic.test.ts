...
import { handleArxiv } from "@vib-rato/coding-agent/web/scrapers/arxiv";
import { handleIacr } from "@vib-rato/coding-agent/web/scrapers/iacr";
import { handlePubMed } from "@vib-rato/coding-agent/web/scrapers/pubmed";
import { handleSemanticScholar } from "@vib-rato/coding-agent/web/scrapers/semantic-scholar";
import type { RenderResult } from "@vib-rato/coding-agent/web/scrapers/types";
