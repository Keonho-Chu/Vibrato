...
import { handleDevTo } from "@vib-rato/coding-agent/web/scrapers/devto";
import { handleGitLab } from "@vib-rato/coding-agent/web/scrapers/gitlab";
import { handleHackerNews } from "@vib-rato/coding-agent/web/scrapers/hackernews";
import { handleLobsters } from "@vib-rato/coding-agent/web/scrapers/lobsters";
