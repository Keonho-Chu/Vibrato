...
import { handleArtifactHub } from "@vib-rato/coding-agent/web/scrapers/artifacthub";
import { handleCoinGecko } from "@vib-rato/coding-agent/web/scrapers/coingecko";
import { handleDiscogs } from "@vib-rato/coding-agent/web/scrapers/discogs";
