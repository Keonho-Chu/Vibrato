...
import { handleHuggingFace } from "@vib-rato/coding-agent/web/scrapers/huggingface";
import { handleSpotify } from "@vib-rato/coding-agent/web/scrapers/spotify";
import { handleVimeo } from "@vib-rato/coding-agent/web/scrapers/vimeo";
