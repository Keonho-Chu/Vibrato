...
import { handleAur } from "@vib-rato/coding-agent/web/scrapers/aur";
import { handleBrew } from "@vib-rato/coding-agent/web/scrapers/brew";
import { handleMaven } from "@vib-rato/coding-agent/web/scrapers/maven";
import { handleNuGet } from "@vib-rato/coding-agent/web/scrapers/nuget";
import { handlePackagist } from "@vib-rato/coding-agent/web/scrapers/packagist";
import { handleRubyGems } from "@vib-rato/coding-agent/web/scrapers/rubygems";
