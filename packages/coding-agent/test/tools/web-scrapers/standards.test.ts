...
import { handleCheatSh } from "@vib-rato/coding-agent/web/scrapers/cheatsh";
import { handleRfc } from "@vib-rato/coding-agent/web/scrapers/rfc";
import { handleTldr } from "@vib-rato/coding-agent/web/scrapers/tldr";
