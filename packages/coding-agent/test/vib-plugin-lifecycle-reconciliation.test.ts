...
): NormalizedVibPluginBundle {
	return {
		name: "bundle",
		version,
		root: "/source",
		manifestPath: "/source/vibrato-plugin.json",
		manifestHash,
		surfaces,
		files,
	};
...
function entry(scope: "project" | "user" = "project", name = "bundle"): VibPluginRegistryEntry {
	return {
		name,
		version: "1.0.0",
		scope,
		...
		manifestPath: "/installed/vibrato-plugin.json",
		manifestHash: "manifest",
...
describe("Vibrato bundle lifecycle reconciliation", () => {
