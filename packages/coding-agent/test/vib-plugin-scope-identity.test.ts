...
function entry(
	scope: "user" | "project",
	name: string,
	s: Partial<NormalizedVibPluginSurfaces> = {},
	...
	return {
		...
		manifestPath: `/tmp/${scope}-${name}/vibrato-plugin.json`,
...
function bundle(name: string, s: Partial<NormalizedVibPluginSurfaces>): NormalizedVibPluginBundle {
	return {
		...
		version: "1.0.0",
		root: "/tmp/source",
		manifestPath: "/tmp/source/vibrato-plugin.json",
...
describe("Vibrato plugin scope-qualified identities", () => {
