...
import type { Goal } from "@vib-rato/coding-agent/goals/state";
import { writeCurrentSessionGoalModeState } from "@vib-rato/coding-agent/vib-runtime/goal-mode-request";
import {
	resolveSessionIdFromSources,
	SessionResolutionError,
} from "@vib-rato/coding-agent/vib-runtime/session-resolution";
import { validateCliReplay } from "@vib-rato/coding-agent/vib-runtime/ultragoal-evidence";
