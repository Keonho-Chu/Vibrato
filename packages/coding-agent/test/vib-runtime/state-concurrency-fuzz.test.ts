...
import type { SkillActiveState } from "@vib-rato/coding-agent/skill-state/active-state";
import { activeSnapshotPath, auditPath, sessionStateDir } from "@vib-rato/coding-agent/vib-runtime/session-layout";
import {
	AlreadyExistsError,
	appendJsonl,
	createJsonNoClobber,
	...
	writeActiveEntry,
} from "@vib-rato/coding-agent/vib-runtime/state-writer";
...
describe("vib state no-lock concurrency fuzz", () => {
