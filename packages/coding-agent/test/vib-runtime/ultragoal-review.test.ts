...
import { modeStatePath as sessionModeStatePath } from "@vib-rato/coding-agent/vib-runtime/session-layout";
import {
	createUltragoalPlan,
	readUltragoalLedger,
	readUltragoalPlan,
...
beforeEach(() => {
	...
	process.env.CI_DEV_CHANGED_PATHS = "packages/coding-agent/test/vib-runtime/ultragoal-review.test.ts";
});
