	...
	return (
		<header className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 pb-6 mb-8 border-b border-[var(--border-subtle)]">
			<div className="flex items-center gap-3">
				<div className="w-10 h-10 rounded-[var(--radius-md)] bg-[image:var(--brand-gradient)] flex items-center justify-center shadow-lg">
				...
				<div>
					...
					<p className="text-xs text-[var(--text-muted)]">LIG System · Vibrato</p>
				</div>
			</div>
