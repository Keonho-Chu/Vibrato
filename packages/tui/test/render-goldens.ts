...
// be re-sorted below the @vib-rato/tui imports.)
...
import { ImageProtocol } from "@vib-rato/tui/terminal-capabilities";
...
export async function captureRenderGolden(fixture: GoldenFixture): Promise<RenderGoldenCapture> {
	...
	let terminalCapabilities: typeof import("@vib-rato/tui/terminal-capabilities") | null = null;
	...
	try {
		...
		terminalCapabilities =
			fixture.imageProtocol === undefined ? null : await import("@vib-rato/tui/terminal-capabilities");
