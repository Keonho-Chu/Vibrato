 ...
 */
import type { AgentEvent, AgentMessage, ResolvedThinkingLevel, ThinkingLevel } from "@vib-rato/agent-core";
import type { Model } from "@vib-rato/ai";
import type { AgentSession, AgentSessionEvent, AuthStorage, SessionStats } from "@vib-rato/coding-agent";
import {
...
export async function discoverSharedInfra(options: DiscoverSharedInfraOptions = {}): Promise<SharedInfra> {
	const { ModelRegistry: MR } = await import("@vib-rato/coding-agent");
