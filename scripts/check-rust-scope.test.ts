...
describe("Rust scope guard", () => {
	test("allowlists the Vibrato SDK Rust core with a native transport rationale", async () => {
		...
		expect(stdout).toContain("crates/vib-sdk");
		expect(stdout).toContain("Vibrato SDK Rust core");
