...
import { listCommandRefBlocks, renderCommandRefBlock } from "../packages/coding-agent/src/vib-runtime/workflow-command-ref";
...
function usage(): never {
	console.error("Usage: bun scripts/generate-vib-skill-command-refs.ts [--check] [--strict] [--json]");
	process.exit(2);
}
...
function main(): void {
	...
	if (json) {
		...
		console.log("Vibrato skill command-ref proof spike (read-only)");
